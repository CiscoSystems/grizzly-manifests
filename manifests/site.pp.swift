...
$build_node_name        = "cvf2-server-a1"
...
$controller_node_address       = '2.1.1.3'
$controller_node_network       = '2.1.1.0'
...
# OpenStack controller. Change the "ip" to the IP address of your OpenStack controller
  ...
  cobbler_node { "control-server":
    node_type => "control",
    mac => "90:e2:ba:0d:26:fc",
    ip => "2.1.1.3",
    power_address  => "192.168.2.34",
    power_user => "admin",
...
#  cobbler_node { "compute-server01":
#    node_type => "compute",
#    mac => "90:e2:ba:0f:6d:28",
#    ip => "2.1.1.4",
#    power_address  => "192.168.2.35:org-cisco",
...
node cvf2-server-a1 inherits build-node { }

# Change control_server to the host name of your control node
node /control-server/ inherits swift_storage {
